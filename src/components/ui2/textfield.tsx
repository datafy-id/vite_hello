  ...
  return (
    <AriaInput
      className={composeRenderProps(className, (className) =>
        cn(
          "flex h-9 w-full rounded-md border border-input bg-transparent px-3 py-1 text-sm shadow-xs transition-colors file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground",
          /* Disabled */
    ...
    <AriaTextArea
      className={composeRenderProps(className, (className) =>
        cn(
          ...
          /* Focused */
          "data-focused:outline-hidden data-focused:ring-2 data-focused:ring-ring data-focused:ring-offset-2",
          /* Disabled */
          "data-disabled:cursor-not-allowed data-disabled:opacity-50",
          /* Resets */
          "focus-visible:outline-hidden",
